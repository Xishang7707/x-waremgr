...
namespace api.Servers
{
    public abstract class BaseServiceImpl
    {
        ...
        protected IDbHelper g_dbHelper { get { lock (this) { if (_g_dbHelper == null) { _g_dbHelper = new DBHelper("main"); } } return _g_dbHelper; } set { lock (this) { _g_dbHelper = value; } } }//数据库操作
