...
namespace common.Redis
{
    ...
    public class RedisHelper
    {
        ...
        private static _RedisHelper _redis;
        public static _RedisHelper Instance
        {
            get
            {
                lock (obj)
                {
                    ...
                    _redis = new _RedisHelper(MakeConnStr());
                }
                return _redis;
            }
        }
        ...
        {
            return string.Format($@"{GConfig.CacheConfig.RedisHost},defaultDatabase={GConfig.CacheConfig.RedisDBNum},password={GConfig.CacheConfig.RedisPwd}");
        }
    }
    ...
    /// Redis读写帮助类
    /// </summary>
    public class _RedisHelper
    {
        private ConnectionMultiplexer _redis { get; set; }
        private IDatabase db { get; set; }
        public _RedisHelper(string connection)
        {
        ...
        /// <param name="obj"></param>
        /// <returns></returns>
        public async Task<bool> SetStringKeyAsync<T>(string key, T obj, TimeSpan? expiry = default(TimeSpan?))
        {
            string json = JsonConvert.SerializeObject(obj);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<T> GetStringKeyAsync<T>(string key) where T : class
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public async Task<bool> DeleteStringKeyAsync(string key)
        {
